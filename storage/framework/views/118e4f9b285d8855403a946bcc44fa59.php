    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2 align-items-center">
                <img width="20" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/customer_review.png')); ?>" alt="">
                    ...
                    <div class="col-md-4">
                        <div>
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option value="1" <?php echo e(!is_null($status) && $status == 1 ? 'selected' : ''); ?>>
                                    <?php echo e(translate('active')); ?></option>
                                <option value="0" <?php echo e(!is_null($status) && $status == 0 ? 'selected' : ''); ?>>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a class="dropdown-item"
                                       href="<?php echo e(route('admin.reviews.export', ['search'=>request('search'), 'product_id' => $product_id, 'customer_id' => $customer_id, 'status' => $status, 'from' => $from, 'to' => $to])); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(isset($review->product)): ?>
                                    <a href="<?php echo e($review['product_id'] ? route('admin.products.view', ['addedBy'=>$review->product->added_by,'id'=>$review->product->id]) : 'javascript:'); ?>"
                            ...
                            <td>
                                <label class="badge badge-soft-info mb-0">
                                        <span class="fz-12 d-flex align-items-center gap-1"><?php echo e($review->rating); ?>
                                    ...
                                    <?php if($review->attachment): ?>
                                        <div class="d-flex flex-wrap">
                                            <?php $__currentLoopData = json_decode($review->attachment); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(dynamicStorage(path: 'storage/app/public/review').'/'.$img); ?>"
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.reviews.status', [$review['id'], $review->status ? 0 : 1])); ?>"
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/reviews/list.blade.php ENDPATH**/ ?>