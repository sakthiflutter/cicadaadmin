            ...
            <tr>
                ...
                <td>
                    <input type="text" name="sku_<?php echo e($combination['type']); ?>" value="<?php echo e($combination['sku']); ?>"
                           class="form-control" placeholder="<?php echo e(translate('ex')); ?>: <?php echo e(translate('MCU47V593M')); ?>">
                </td>
                <td>
...
<?php endif; ?>
<?php /**PATH /var/www/html/moores/resources/views/vendor-views/product/partials/_edit_sku_combinations.blade.php ENDPATH**/ ?>