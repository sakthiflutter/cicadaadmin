<?php $__env->startSection('title', translate('customer_loyalty_point_report')); ?>

<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img width="20" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/loyalty_point.png')); ?>" alt="">
                <?php echo e(translate('customer_loyalty_point_report')); ?>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 pt-3">
                        <form action="<?php echo e(route('admin.customer.loyalty.report')); ?>" method="get">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        ?>
                                        <select name="transaction_type" id="" class="form-control" title="<?php echo e(translate('select_transaction_type')); ?>">
                                            <option value=""><?php echo e(translate('all')); ?></option>
                                            <option value="point_to_wallet" <?php echo e(isset($transaction_status) && $transaction_status=='point_to_wallet'?'selected':''); ?>><?php echo e(translate('point_to_wallet')); ?></option>
                                            ...
                                            <option value="refund_order" <?php echo e(isset($transaction_status) && $transaction_status=='refund_order'?'selected':''); ?>><?php echo e(translate('refund_order')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
        ...
        <div class="card mt-3">
            <div class="card-header text-capitalize gap-2">
                <h4 class="mb-0 text-nowrap ">
                    ...
                    <span class="badge badge-soft-dark radius-50 fz-12 ml-1"><?php echo e(count($transactions)); ?></span>
                </h4>
                <div class="d-flex justify-content-end">
                    <div class="dropdown text-nowrap">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a type="submit" class="dropdown-item d-flex align-items-center gap-2 " href="<?php echo e(route('admin.customer.loyalty.export',['transaction_type'=>$transaction_status,'customer_id'=>request('customer_id'),'to'=>request('to'),'from'=>request('from')])); ?>">
                ...
                <table id="datatable"
                    ...
                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr scope="row">
                            ...
                            <td><a href="<?php echo e(route('admin.customer.view',['user_id'=>$transaction['user_id']])); ?>" class="title-color hover-c1"><?php echo e(Str::limit($transaction->user?$transaction->user->f_name.' '.$transaction->user->l_name:translate('not_found'),20)); ?></a></td>
                            <td><?php echo e($transaction['credit']); ?></td>
                            <td><?php echo e($transaction['debit']); ?></td>
                            <td><?php echo e($transaction['balance']); ?></td>
                            <td>
                                <span class="badge badge-soft-<?php echo e($transaction['transaction_type']=='order_refund'
                                    ?'danger'
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/customer/loyalty/report.blade.php ENDPATH**/ ?>