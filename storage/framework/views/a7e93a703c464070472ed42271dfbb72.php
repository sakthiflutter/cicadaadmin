        ...
        <div class=" inline_product clickable d-flex justify-content-center">
            ...
            <div class="p-10px pb-0">
                <a href="<?php echo e(route('product',$product->slug)); ?>" class="w-100">
                    <img alt="" src="<?php echo e(getValidImage(path: 'storage/app/public/product/thumbnail/'.$product['thumbnail'], type: 'product')); ?>">
                </a>
            </div>
...
<?php /**PATH /var/www/html/moores/resources/themes/default/web-views/partials/_filter-single-product.blade.php ENDPATH**/ ?>