                                        ...
                                        <div>
                                            <?php if($product['request_status'] == 0): ?>
                                                <button class="btn btn-success p-2 px-3 update-status"
                                                   ...
                                                   data-redirect-route="<?php echo e(route('admin.products.list',['seller', 'status' => $product['request_status']])); ?>"
                                                   data-message ="<?php echo e(translate('want_to_approve_this_product_request_request').'?'); ?>" data-status="1">
                                            ...
                                            <div class="">
                                                <ul class="list-unstyled list-unstyled-py-2 mb-0">
                                                    ...
                                                    <li class="d-flex align-items-center font-size-sm">
                                                        ...
                                                        <span class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'); ?>">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <div class="row gy-3 flex-grow-1">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                <div>
                                    <span class="key text-nowrap text-capitalize"><?php echo e(translate('unit_price')); ?></span>
                                    <span>:</span>
                                    <span class="value">
                                ...
                                <?php if($product->product_type == 'physical'): ?>
                                    <div>
                                        <span class="key text-nowrap text-capitalize"><?php echo e(translate('shipping_cost')); ?></span>
                                        <span>:</span>
                                        <span class="value">
                    ...
                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(isset($review->customer)): ?>
                            <tr>
                                                ...
                                                <a class="aspect-1 float-left overflow-hidden"
                                                   ...
                                                   data-lightbox="review-gallery<?php echo e($review['id']); ?>" >
                                                    <img class="p-2" width="60" height="60"
                                                         src="<?php echo e(getValidImage(path: 'storage/app/public/review/'.$img,type: 'backend-basic')); ?>" alt="<?php echo e(translate('review_image')); ?>">
                                                </a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <td>
                                    <form
                                        action="<?php echo e(route('admin.reviews.status', [$review['id'], $review->status ? 0 : 1])); ?>"
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/product/view.blade.php ENDPATH**/ ?>