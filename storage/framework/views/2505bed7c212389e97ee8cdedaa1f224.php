            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><?php echo e(translate('privacy_policy')); ?></h5>
                    </div>
                    <form action="<?php echo e(route('admin.business-settings.privacy-policy')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="form-group">
                                <textarea class="form-control summernote" id="editor" name="value"><?php echo e($privacy_policy->value); ?></textarea>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/business-settings/page/privacy-policy.blade.php ENDPATH**/ ?>