...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="<?php echo e(route('vendor.products.update',$product->id)); ?>" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="digital_product_type_show">
                            <div class="form-group">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                      title="<?php echo e(translate('for_“Ready_Product”_deliveries,_customers_can_pay_&_instantly_download_pre-uploaded_digital_products._For_“Ready_After_Sale”_deliveries,_customers_pay_first_then_vendor_uploads_the_digital_products_that_become_available_to_customers_for_download')); ?>">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="digital_file_ready_show">
                            <div class="form-group">
                                ...
                                <div class="mt-2">
                                    <?php echo e(translate('file_type')); ?>: <?php echo e("jpg, jpeg, png, gif, zip, pdf"); ?>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="generate_number" name="code" class="form-control"
                                       value="<?php echo e($product['code']); ?>" placeholder="<?php echo e(translate('123412')); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tags"
                                       value="<?php $__currentLoopData = $product['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($tag->tag.','); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>"
                                       data-role="tagsinput">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-12 mt-2 mb-2">
                            ...
                            <div class="sku_combination table-responsive form-group mt-2" id="sku_combination">
                                <?php echo $__env->make('vendor-views.product.partials._edit_sku_combinations',['combinations'=>json_decode($product['variation'],true)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-3 rest-part">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div>
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                              title="<?php echo e(translate('add_your_products_thumbnail_in')); ?> <?php echo e("JPG, PNG or JPEG"); ?> <?php echo e(translate('format_within')); ?> 2MB">
                                            <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg')); ?>" alt="">
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                          title="<?php echo e(translate('add_color_wise_product_images_here')); ?>.">
                                        <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg')); ?>" alt="">
                                    </span>
                                </div>
                                <p class="text-muted"><?php echo e(translate('must_upload_colour_wise_images_first')); ?> <?php echo e(translate('colour_is_shown_in_the_image_section_top_right.')); ?> </p>
                                                ...
                                                <div class="col-sm-12 col-md-4">
                                                    <div
                                                        ...
                                                        <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn"
                                                           href="<?php echo e(route('vendor.products.delete-image',['id'=>$product['id'],'name'=>$photo])); ?>">
                                                            <i class="tio-delete"></i>
                                                        </a>
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <img alt="" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/icons/product-upload-icon.svg')); ?>"
                                                                     class="w-75">
                                                                <h3 class="text-muted"><?php echo e(translate('Upload_Image')); ?></h3>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php if($photo->color == null): ?>
                                                        ...
                                                        <div class="col-sm-12 col-md-4">
                                                            <div
                                                                class="custom_upload_input custom-upload-input-file-area position-relative border-dashed-2 aspect-1">
                                                                <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn"
                                                                   href="<?php echo e(route('vendor.products.delete-image',['id'=>$product['id'],'name'=>$photo->image_name,'color'=>'null'])); ?>">
                                                                    <i class="tio-delete"></i>
                                                                </a>
                ...
                <input type="hidden" id="remove_url" value="<?php echo e(route('vendor.products.delete-image')); ?>">
            </div>
    ...
    <span id="route-vendor-products-sku-combination" data-url="<?php echo e(route('vendor.products.sku-combination')); ?>"></span>
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/vendor/product-add-update.js')); ?>"></script>
    ...
    <script>
                            ...
                            <div class="col-6 col-md-4 col-xl-4">
                                <div class="position-relative p-2 border-dashed-2 aspect-1">
                                    ...
                                    <img class="w-100" height="auto"
                                        src="<?php echo e(getValidImage(path:'storage/app/public/product/`+image_name+`',type: 'backend-product')); ?>"
                                        alt="Product image">
                                </div>
                            </div>`;
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequestFunctionality('<?php echo e(route('vendor.products.get-categories')); ?>?parent_id=' + category + '&sub_category=' + sub_category, 'sub-category-select', 'select');
                getRequestFunctionality('<?php echo e(route('vendor.products.get-categories')); ?>?parent_id=' + sub_category + '&sub_category=' + sub_sub_category, 'sub-sub-category-select', 'select');
            }, 100)
        });
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/vendor-views/product/edit.blade.php ENDPATH**/ ?>