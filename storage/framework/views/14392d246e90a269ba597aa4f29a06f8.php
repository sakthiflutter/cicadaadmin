                ...
                <div class="card __card d-none d-lg-flex web-direction customer-profile-orders">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-0 mb-md-3">
                            <h5 class="font-bold mb-0 fs-16"><?php echo e(translate('my_Order')); ?></h5>
                        </div>
                                        ...
                                        <td class="bodytr">
                                            <div class="media-order">
                                                ...
                                                <?php if($order->seller_is == 'seller'): ?>
                                                    <img alt="<?php echo e(translate('shop')); ?>"
                                                         src="<?php echo e(getValidImage(path: 'storage/app/public/shop/'.(isset($order->seller->shop) ? $order->seller->shop->image:'shop'), type: 'shop')); ?>">
                                                ...
                                                <h6 class="font-weight-bold m-0 mb-1">
                                                    <a href="<?php echo e(route('account-order-details', ['id'=>$order->id])); ?>"
                                                        ...
                                                        <?php echo e(translate('order')); ?>  #<?php echo e($order['id']); ?>

                                                    </a>
                                                </h6>
                                                    <span class="fs-12 font-weight-medium">
                                                        <?php echo e($order->order_details_sum_qty); ?> <?php echo e(translate('items')); ?>
                        ...
                        <?php else: ?>
                            <div class="text-center pt-5 text-capitalize">
                                <img src="<?php echo e(theme_asset(path: 'public/assets/front-end/img/icons/order.svg')); ?>" alt="" width="70">
                            ...
                            <div class="d-flex border-lighter rounded p-2 justify-content-between gap-2">
                                <div class="">
                                    <div class="media-order">
                                        <a href="<?php echo e(route('account-order-details', ['id'=>$order->id])); ?>" class="d-block position-relative">
                                            <?php if($order->seller_is == 'seller'): ?>
                                                <img class="border-lighter" alt="<?php echo e(translate('shop')); ?>"
                                                     src="<?php echo e(getValidImage(path: 'storage/app/public/shop/'.(isset($order->seller->shop) ? $order->seller->shop->image:'shop'), type: 'shop')); ?>">
                                            <?php elseif($order->seller_is == 'admin'): ?>
                                                <img alt="<?php echo e(translate('shop')); ?>"
                                                     src="<?php echo e(getValidImage(path: 'storage/app/public/company/'.$web_config['fav_icon']->value, type: 'logo')); ?>">
                                        ...
                                        <div class="cont text-start">
                                            <h6 class="font-weight-bold mb-1 fs-14">
                                                <a class="fs-12 font-semibold" href="<?php echo e(route('account-order-details', ['id'=>$order->id])); ?>">
                                                    <?php echo e(translate('order')); ?> #<?php echo e($order['id']); ?>

                                                </a>
                                            </h6>
                                            <div class="d-flex flex-column gap-1 fs-12">
                                                <span class="fs-12 font-weight-normal"><?php echo e($order->order_details_sum_qty); ?> <?php echo e(translate('items')); ?></span>
                                                <div class="fs-11 font-semibold text-secondary-50"><?php echo e(date('d M, Y h:i A',strtotime($order['created_at']))); ?></div>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="text-nowrap fs-11 font-semibold text-secondary-50"><?php echo e(translate('total')); ?> :</div>
                                                    <div class="text-dark fs-13 font-weight-bold"><?php echo e(webCurrencyConverter(amount: $order['order_amount'])); ?></div>
                                                </div>
                                                <div class="my-2">
                                                    <?php if($order['order_status']=='failed' || $order['order_status']=='canceled'): ?>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/themes/default/web-views/users-profile/account-orders.blade.php ENDPATH**/ ?>