...
<?php $__env->startSection('title', translate('third_party_apis')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form
                    action="<?php echo e(env('APP_MODE') != 'demo' ? route('admin.business-settings.map-api') : 'javascript:'); ?>"
                    method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="d-flex align-items-center gap-2 justify-content-between mb-3">
                        <h4 class="text-capitalize mb-0"><?php echo e(translate('google_map_API_setup')); ?></h4>
                        <div class="btn-group">
                            ...
                            <div
                                ...
                                <p class="title-color font-weight-medium mb-0"><?php echo e(translate('without_configuring_this_section_map_functionality_will_not_work_properly').' '.translate('thus_the_whole_system_will_not_work_as_it_planned')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-2 mb-4 valley-alert">
                        ...
                        <p class="mb-0">
                            <strong><?php echo e(translate('NB').':'); ?></strong>
                             <?php echo e(translate('client_key_should_have_enable_map_javascript_api_and_you_can_restrict_it_with_http_refer').' '.translate('server_key_should_have_enable_place_api_key_and_you_can_restrict_it_with_ip').' '.translate('you_can_use_same_api_for_both_field_without_any_restrictions').'.'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(translate('map_api_key').'('.translate('client').')'); ?> </label>
                                <input type="text" placeholder="<?php echo e(translate('map_api_key'.'('.translate('client').')')); ?>"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex"><?php echo e(translate('map_api_key')); ?> (<?php echo e(translate('server')); ?>

                                    )</label>
                                <input type="text" placeholder="<?php echo e(translate('map_api_key')); ?> (<?php echo e(translate('server')); ?>)"
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/business-settings/map-api/index.blade.php ENDPATH**/ ?>