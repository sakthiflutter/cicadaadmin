...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap flex-md-nowrap gap-10 justify-content-between mb-4">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <?php if($linkedOrders->count() >0): ?>
                                    <div class="d-flex flex-wrap gap-10">
                                        <div
                                            class="color-caribbean-green-soft font-weight-bold d-flex align-items-center rounded py-1 px-2"> <?php echo e(translate('linked_orders')); ?>

                                            (<?php echo e($linkedOrders->count()); ?>) :
                                        </div>
                                        <?php $__currentLoopData = $linkedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linked): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="text-sm-right flex-grow-1">
                                <div class="d-flex flex-wrap gap-10 justify-content-end">
                                    <?php if($order->verification_images && count($order->verification_images)>0 && $order->verification_status ==1): ?>
                                        <div>
                                ...
                                <div class="d-flex flex-column gap-2 mt-3">
                                    <div class="order-status d-flex justify-content-sm-end gap-10 text-capitalize">
                                        ...
                                        <?php if($order['order_status']=='pending'): ?>
                                            <span
                                                class="badge color-caribbean-green-soft font-weight-bold radius-50 d-flex align-items-center py-1 px-2"><?php echo e(translate(str_replace('_',' ',$order['order_status']))); ?></span>
                                        <?php elseif($order['order_status']=='failed'): ?>
                                            <span
                                                class="badge badge-soft-danger font-weight-bold radius-50 d-flex align-items-center py-1 px-2"><?php echo e(translate(str_replace('_',' ',$order['order_status'] == 'failed' ? 'Failed to Deliver' : ''))); ?>
                                    ...
                                    <?php if($order->payment_method != 'cash_on_delivery' && $order->payment_method != 'pay_by_wallet' && !isset($order->offlinePayments)): ?>
                                        <div
                                    ...
                                    <?php if(getWebConfig('order_verification')): ?>
                                        <span class="">
                                            <b>
                                ...
                                <?php $__currentLoopData = $order->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($productDetails): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    <img class="avatar avatar-60 rounded"
                                                         src="<?php echo e(getValidImage(path: 'storage/app/public/product/thumbnail/'.$productDetails->thumbnail, type: 'backend-product')); ?>" alt="<?php echo e(translate('image_Description')); ?>">
                                                    <div>
                                                ...
                                                <?php if(isset($productDetails->digital_product_type) && $productDetails->digital_product_type == 'ready_after_sell'): ?>
                                                    <button type="button" class="btn btn-sm btn--primary mt-2"
                                                            title="<?php echo e(translate('file_upload')); ?>" data-toggle="modal"
                                            ...
                                            <td>
                                                <?php echo e(setCurrencySymbol(amount: usdToDefaultCurrency(amount: $detail['price']*$detail['qty']), currencyCode: getCurrencyCode())); ?>
                                                        ...
                                                        <div class="modal-body">
                                                            <?php if($detail->digital_file_after_sell): ?>
                                                                <div class="mb-4">
                                                                    ...
                                                                    <a href="<?php echo e(dynamicStorage(path: 'storage/app/public/product/digital-product/'.$detail->digital_file_after_sell)); ?>"
                                                                       class="btn btn-success btn-sm" title="<?php echo e(translate('download')); ?>"><i
                                                            ...
                                                            <?php if(($product_details->added_by == 'admin') && $detail->seller_id == 1): ?>
                                                                ...
                                                                <div class="mt-1 text-info">
                                                                    <?php echo e(translate('file_type').' '.':'.' '.'jpg, jpeg, png, gif, zip, pdf'); ?>

                                                                </div>
                                                                <input type="hidden" value="<?php echo e($detail->id); ?>" name="order_id">
                                                            <?php else: ?>
                                                                <h4 class="mt-3 text-center"><?php echo e(translate('admin_have_no_permission_for_vendors_digital_product_upload')); ?></h4>
                                                            <?php endif; ?>
                                                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                <h4 class="d-flex gap-2">
                                    <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/product_setup.png')); ?>" alt=""
                                         width="20">
                            ...
                            <ul class="list-unstyled list-unstyled-py-4">
                                ...
                                <li class="choose_delivery_man">
                                    ...
                                    <select class="form-control text-capitalize js-select2-custom"
                                            name="delivery_man_id" id="addDeliveryMan" data-order-id="<?php echo e($order['id']); ?>">
                                        <option
                                            value="0" <?php echo e(isset($order->deliveryMan) ? 'disabled':''); ?>><?php echo e(translate('select')); ?></option>
                                    ...
                                    <?php else: ?>
                                        <div class="p-2 bg-light rounded mt-4">
                                            <div class="media m-1 gap-3">
                                                <img class="avatar rounded-circle"
                                                     src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/delivery-man.png')); ?>"
                                                     alt="<?php echo e(translate('Image')); ?>">
                                                <div class="media-body">
                                ...
                                <?php if(isset($order->deliveryMan)): ?>
                                    <li class="choose_delivery_man">
                                        <label class="font-weight-bold title-color d-flex fz-14">
                                            ...
                                            <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="top" title="<?php echo e(translate('encourage_your_deliveryman_by_giving_him_incentive').' '.translate('this_amount_will_be_count_as_admin_expense').'.'); ?>">
                                    ...
                                    <li class="choose_delivery_man">
                                        <label class="font-weight-bold title-color fz-14"><?php echo e(translate('expected_delivery_date')); ?></label>
                                        <input type="date" data-order-id="<?php echo e($order['id']); ?>"
                                               value="<?php echo e($order->expected_delivery_date); ?>" name="expected_delivery_date" id="expected_delivery_date"
                                ...
                                <li class="mt-1" id="by_third_party_delivery_service_info">
                                    <div class="p-2 bg-light rounded">
                                        <div class="media m-1 gap-3">
                                            <img class="avatar rounded-circle"
                                                 src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/third-party-delivery.png')); ?>"
                                                 alt="<?php echo e(translate('image')); ?>">
                                            <div class="media-body">
                                                <h5 class=""><?php echo e($order->delivery_service_name ?? translate('not_assign_yet')); ?></h5>
                                                <span
                                                    class="fz-12 title-color"><?php echo e(translate('track_ID').' '.':'.' '.$order->third_party_delivery_tracking_id); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="media flex-wrap gap-3">
                                <div class="">
                                    <img class="avatar rounded-circle avatar-70"
                                         src="<?php echo e(getValidImage(path: 'storage/app/public/profile/'.$order->customer->image , type: 'backend-basic')); ?>"
                                         alt="<?php echo e(translate('Image')); ?>">
                                </div>
                                <div class="media-body d-flex flex-column gap-1">
                                    <span
                                        class="title-color"><strong><?php echo e($order->customer['f_name'].' '.$order->customer['l_name']); ?> </strong></span>
                                    <span class="title-color"> <strong><?php echo e($orderCount); ?></strong> <?php echo e(translate('orders')); ?></span>
                                    <span
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex align-items-start gap-2">
                                        ...
                                        <?php echo e($shippingAddress->address  ?? translate('empty')); ?>
                    ...
                    <?php if($billing): ?>
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                ...
                                <?php if($order['order_status'] != 'delivered'): ?>
                                    <button class="btn btn-outline-primary btn-sm square-btn billing-address-update-modal" title="<?php echo e(translate('edit')); ?>"
                            ...
                            <?php if($order->seller_is == 'admin'): ?>
                                <div class="mr-3">
                                    <img class="avatar rounded avatar-70 img-fit-contain "
                                         src="<?php echo e(getValidImage(path: 'storage/app/public/company/'.$companyWebLogo , type: 'backend-basic')); ?>" alt="">
                                </div>
                            ...
                            <?php else: ?>
                                <?php if(!empty($order->seller->shop)): ?>
                                    ...
                                    <div class="media-body d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex align-items-start gap-2">
                                            <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/location.png')); ?>"
                                                 class="mt-1" alt="">
    ...
    <?php if($order->verification_images && count($order->verification_images)>0): ?>
                                ...
                                <?php $__currentLoopData = $order->verification_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-4 col-sm-6 ">
                                        <div class="mb-2 mt-2 border-1">
                                            <img
                                                src="<?php echo e(getValidImage(path: 'storage/app/public/delivery-man/verification-image/'.$image->image , type: 'backend-basic')); ?>"
                                                class="w-100" alt="" >
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                               ...
                                               placeholder="<?php echo e(translate('ex')); ?>: <?php echo e(translate('john_doe')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="city" id="city"
                                               ...
                                               class="form-control"
                                               placeholder="<?php echo e(translate('ex')); ?>:<?php echo e(translate('dhaka')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" name="address" rows="3"
                                                  class="form-control"
                                                  placeholder="<?php echo e(translate('ex')); ?> : <?php echo e(translate('street_1,_street_2,_street_3,_street_4')); ?>"><?php echo e($shippingAddress ? $shippingAddress->address : ''); ?></textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="billing_address" rows="3"
                                                          class="form-control"
                                                          placeholder="<?php echo e(translate('ex')); ?> : <?php echo e(translate('street_1,_street_2,_street_3,_street_4')); ?>"><?php echo e($billing ? $billing->address : ''); ?></textarea>
                                            </div>
                                        </div>
    ...
    <span id="message-status-title-text"
          data-text="<?php echo e($order['payment_method'] != 'cash_on_delivery' && $order['order_status']=='delivered' ? translate("Order_is_already_delivered_and_transaction_amount_has_been_disbursed_changing_status_can_be_the_reason_of_miscalculation") : translate("are_you_sure_change_this")); ?>"></span>
    <span id="message-status-subtitle-text"
          data-text="<?php echo e($order['payment_method'] != 'cash_on_delivery' && $order['order_status']=='delivered' ? translate('think_before_you_proceed') : translate("you_will_not_be_able_to_revert_this")); ?>!"></span>
    ...
    <span id="order-status-url" data-url="<?php echo e(route('admin.orders.status')); ?>"></span>
    <span id="payment-status-url" data-url="<?php echo e(route('admin.orders.payment-status')); ?>"></span>
    ...
    <span id="add-delivery-man-url" data-url="<?php echo e(url('/admin/orders/add-delivery-man/'.$order['id'])); ?>/"></span>
    ...
    <span id="add-date-update-url" data-url="<?php echo e(route('admin.orders.amount-date-update')); ?>"></span>
    ...
    <span id="customer-image"
          data-path="<?php echo e(dynamicStorage(path: 'storage/app/public/profile/')); ?><?php echo e($order->customer->image??""); ?>"></span>
...
<?php $__env->startPush('script_2'); ?>
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(getWebConfig('map_api_key')); ?>&callback=map_callback_fucntion&libraries=places&v=3.49" defer></script>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/order/order-details.blade.php ENDPATH**/ ?>