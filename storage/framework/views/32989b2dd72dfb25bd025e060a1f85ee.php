...
<div class="container py-5 rtl text-start">
    ...
    <h3 class="mb-3 text-center fs-24 font-semi-bold text-capitalize"> <?php echo e(translate('shop_application')); ?></h3>
    <form class="__shop-apply" action="<?php echo e(route('vendor.auth.registration.index')); ?>" id="vendor-registration-form" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card __card mb-3">
            <div class="card-header">
                <h5 class="card-title m-0 fs-16 font-semi-bold d-flex align-items-center gap-2">
                    <i class="fa fa-user-o" aria-hidden="true"></i>
                    <span><?php echo e(translate('vendor_Info')); ?></span>
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control form-control-user phone-input-with-country-picker"
                               type="tel"  value="<?php echo e(old('phone')); ?>" id="exampleInputPhone"
                        ...
                        <div class="form-group mb-0">
                            <div class="password-toggle rtl">
                                <input class="form-control text-align-direction" name="confirm_password" type="password"
                                       placeholder="<?php echo e(translate('repeat_password')); ?>"
                    ...
                    <div class="col-sm-12">
                        <div class="text-center">
                            <img class="__img-125px object-cover" id="viewer"
                                 src="<?php echo e(getValidImage(path: 'public/assets/front-end/img/placeholder/user.png', type: 'avatar')); ?>" alt="banner image"/>
                        </div>
                        <div class="custom-file mt-3">
                            ...
                            <label class="custom-file-label overflow-hidden text-truncate" for="customFileUpload"><?php echo e(translate('upload_image')); ?></label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card __card">
            <div class="card-header">
                <h5 class="card-title m-0 fs-16 font-semi-bold d-flex align-items-center gap-2">
                    ...
                    <span><?php echo e(translate('shop_Info')); ?></span>
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                        ...
                        <div class="pb-3">
                            <div class="text-center">
                                <img class="__img-125px object-cover" id="viewerLogo"
                                     src="<?php echo e(getValidImage(path: 'public/assets/front-end/img/placeholder/placeholder-1-1.png', type: 'logo')); ?>"
                                     alt="banner image"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-0">
                            <div class="custom-file">
                                <input type="file" name="logo" id="Logo-upload"
                                    ...
                                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label overflow-hidden text-truncate" for="Logo-upload"><?php echo e(translate('upload_logo')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="pb-3">
                            <div class="text-center">
                                <img class="height-100px" id="viewerBanner"
                                     src="<?php echo e(getValidImage(path: 'public/assets/front-end/img/placeholder/placeholder-4-1.png', type: 'wide-banner')); ?>"
                                     alt="banner image"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                <input type="file" name="banner" id="banner-upload"
                                       ...
                                       accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label overflow-hidden text-truncate" for="banner-upload"><?php echo e(translate('upload_Banner')); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-6 input-icons mb-2 w-100 rounded bg-white">
                                ...
                                data-link="<?php echo e(route('vendor.auth.recaptcha', ['tmp'=>':dummy-id'])); ?>">
                                    <img src="<?php echo e(route('vendor.auth.recaptcha', ['tmp'=>1]).'?captcha_session_id=sellerRecaptchaSessionKey'); ?>" alt="" class="rounded __h-40" id="default_recaptcha_id">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-0 d-flex flex-wrap justify-content-between">
                            <label class="form-group mb-3 d-flex align-items-center flex-grow-1 cursor-pointer user-select-none">
                                ...
                                <span class="mb-4px d-block w-0 flex-grow pl-1">
                                    ...
                                    <a class="font-size-sm text-force-underline text-primary" target="_blank" href="<?php echo e(route('terms')); ?>">
                        ...
                        <button type="button" class="btn btn--primary btn-user btn-block font-semi-bold form-submit" id="apply" data-form-id="vendor-registration-form" disabled>
                            <?php echo e(translate('apply_Shop')); ?>

                        </button>
                        <div class="text-center">
                            <a class="small"  href="<?php echo e(route('vendor.auth.login')); ?>">
                                <?php echo e(translate('already_have_an_account')); ?> ? <?php echo e(translate('sign_in')); ?>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0">
                <div class="d-flex flex-column align-items-center text-center gap-2 mb-2">
                    <img src="<?php echo e(dynamicAsset(path: 'public/assets/front-end/img/congratulations.png')); ?>" width="70" class="mb-3 mb-20" alt="">
                    <h5 class="modal-title"><?php echo e(translate('congratulations')); ?></h5>
                    <div class="text-center"><?php echo e(translate('your_registration_is_successful').', '.translate('please-wait_for_admin_approval').'.'.translate(' you’ll_get_a_mail_soon')); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/themes/default/web-views/seller-view/auth/register.blade.php ENDPATH**/ ?>