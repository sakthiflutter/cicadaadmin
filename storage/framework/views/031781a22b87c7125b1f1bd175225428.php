    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl text-align-direction">
        <div class="bg-primary-light rounded-10 my-4 p-3 p-sm-4"
            ...
            <div class="d-flex flex-column gap-1 text-primary">
                ...
                <p class="fs-14 fw-semibold mb-0">
                    <?php echo e(translate('Find_your_favourite_brands_and_products')); ?>
        ...
        <div class="brand_div-wrap mb-4">
            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])); ?>" class="brand_div"
                   data-toggle="tooltip" title="<?php echo e($brand->name); ?>">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/themes/default/web-views/products/brands.blade.php ENDPATH**/ ?>