<?php $__env->startSection('title', translate('reCaptcha_Setup')); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card overflow-hidden">
                    <form action="<?php echo e(env('APP_MODE') != 'demo' ? route('admin.business-settings.captcha') : 'javascript:'); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            ...
                            <div class="bg-white rounded-bottom overflow-hidden mb-4">
                                <div class="border rounded border-color-c1 px-4 py-3 d-flex justify-content-between">
                                    <h5 class="mb-0 d-flex gap-1 c1">
                                        ...
                                        <?php endif; ?>
                                        <?php echo e(translate('turn')); ?> <?php echo e(translate(isset($config) && $config['status']==1?'OFF':'ON')); ?>

                                    </h5>
                                    <div class="position-relative">
                                        <label class="switcher">
                                            <input class="switcher_input toggle-switch-message" type="checkbox" name="status"
                                                   id="recaptcha-id" <?php echo e($config['status']==1?'checked':''); ?> value="1"
                                                   data-modal-id = "toggle-modal"
                                                   data-toggle-id = "recaptcha-id"
                                                   data-on-image = "recaptcha-off.png"
                                                   data-off-image = "recaptcha-off.png"
                                                   data-on-title = "<?php echo e(translate('important').'!'); ?>"
                                                   data-off-title = "<?php echo e(translate('warning').'!'); ?>"
                                                   data-on-message = "<p><?php echo e(translate('reCAPTCHA_is_now_enabled_for_added_security').'.'.translate('users_may_be_prompted_to_complete_a_reCAPTCHA_challenge_to_verify_their_human_identity_and protect_against_spam_and_malicious_activity')); ?></p>"
                                                   data-off-message = "<p><?php echo e(translate('disabling_reCAPTCHA_may_leave_your_website_vulnerable_to_spam_and_malicious_activity_and_suspects_that_a_user_may_be_a_bot').' '.translate('it_is_highly_recommended_to_keep_reCAPTCHA_enabled_to_ensure_the_security_and_integrity_of_your_website')); ?></p>">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="title-color font-weight-bold d-flex"><?php echo e(translate('site_Key')); ?></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="title-color font-weight-bold d-flex"><?php echo e(translate('secret_Key')); ?></label>
                                        <input type="text" class="form-control" name="secret_key"
                                                value="<?php echo e(env('APP_MODE')!='demo'?$config['secret_key']??"":''); ?>">
                                    </div>
                                </div>
                            </div>
                            <h5 class="mt-4 mb-3 d-flex"><?php echo e(translate('instructions')); ?></h5>
                            <ol class="pl-4 instructions-list">
                                <li>
                                    <?php echo e(translate('to_get_site_key_and_secret_key_Go_to_the_Credentials_page')); ?>

                                    (<a href="https://www.google.com/recaptcha/admin/create"
                                        target="_blank"><?php echo e(translate('click_here')); ?></a>)
                                </li>
                                <li><?php echo e(translate('add_a_label_(Ex:_abc_company)')); ?></li>
                                <li><?php echo e(translate('select_reCAPTCHA_v2_as_ReCAPTCHA_Type')); ?></li>
                                <li><?php echo e(translate('select_sub_type').':'.translate('im_not_a_robot_checkbox')); ?></li>
                                <li><?php echo e(translate('add_Domain_(For_ex:_demo.6amtech.com)')); ?></li>
                                <li><?php echo e(translate('check_in_“Accept_the_reCAPTCHA_Terms_of_Service”')); ?></li>
                                <li><?php echo e(translate('press_Submit')); ?></li>
                                <li><?php echo e(translate('copy_Site_Key_and_Secret_Key,_Paste_in_the_input_filed_below_and_Save').'.'); ?></li>
                            </ol>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/smtp-server.png')); ?>" loading="lazy" alt="">
                                    ...
                                    <li><?php echo e(translate('contact_your_email_service_provider_or_IT_administrator_to_obtain_the_SMTP_server_details_such_as_hostname_port_username_and_password').'.'); ?></li>
                                        <li><?php echo e(translate('note').':'.translate('if_you`re_not_sure_where_to_find_these_details,_check_the_email_provider`s_documentation_or_support_resources_for_guidance').'.'); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/business-settings/recaptcha-index.blade.php ENDPATH**/ ?>