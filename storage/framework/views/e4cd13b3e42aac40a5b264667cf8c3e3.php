<?php $__env->startSection('title', translate('product_settings')); ?>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 text-capitalize d-flex gap-2 text-capitalize">
                    <img width="20" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/product_setup.png')); ?>" alt="">
                    <?php echo e(translate('product_setup')); ?>

                </h5>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('admin.product-settings.index')); ?>" method="post"
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color d-flex text-capitalize"
                                           for="stock_limit"><?php echo e(translate('re-order_level')); ?></label>
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                          data-placement="right" title="<?php echo e(translate('set_the_stock_limit_for_the_Reorder_level')); ?>

                                    <?php echo e(translate ('vendors_can_see_all_products_that_need_to_be_re_stocked_in_a_section_when_they_reach_this_ReOrder_Level')); ?>">
                                ...
                                <input class="form-control" type="text" name="stock_limit" id="stock_limit"
                                       value="<?php echo e($stockLimit['value']); ?>"
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color text-capitalize">
                                        <?php echo e(translate('sell_digital_product')); ?>

                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                              data-placement="right"
                                              title="<?php echo e(translate('if_enabled_vendors_can_sell_digital_products')); ?> (<?php echo e(translate('software')); ?>, <?php echo e(translate('ebooks')); ?>, <?php echo e(translate('activation_keys')); ?>, JPG, PNG, etc.) <?php echo e(translate('in_their_shops')); ?>">
                                            <img width="16"
                                    ...
                                    <label class="switcher" for="digital-product">
                                        <input type="checkbox" class="switcher_input toggle-switch-message" value="1" name="digital_product"
                                               id="digital-product" <?php echo e($digitalProduct && $digitalProduct['value'] ? 'checked':''); ?>

                                               data-modal-id = "toggle-modal"
                                               data-toggle-id = "digital-product"
                                               data-on-image = "digital-product-on.png"
                                               data-off-image = "digital-product-off.png"
                                               data-on-title = "<?php echo e(translate('want_to_Turn_ON_Digital_Product').'?'); ?>"
                                               data-off-title = "<?php echo e(translate('want_to_Turn_OFF_Digital_Product').'?'); ?>"
                                               data-on-message = "<p><?php echo e(translate('if_enabled_vendors_can_sell_digital_products_in_their_shops')); ?></p>"
                                               data-off-message = "<p><?php echo e(translate('if_disabled_vendors_can_not_sell_digital_products_in_their_shops')); ?></p>">
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color">
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                              data-placement="right"
                                              title="<?php echo e(translate('if_enabled_customers_can_see_brands_on_the_app_and_website').'.'.translate('they_can_browse_and_search_for_products_from_each_brand_inside_any_shop')); ?>">
                                            <img width="16"
                                                 src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg')); ?>" alt="">
                                        </span>
                                    </span>
                                    ...
                                    <label class="switcher" for="product-brand">
                                        <input type="checkbox" class="switcher_input toggle-switch-message" value="1" name="product_brand"
                                               id="product-brand" <?php echo e($brand && $brand['value'] ? 'checked':''); ?>

                                               data-modal-id = "toggle-modal"
                                               data-toggle-id = "product-brand"
                                               data-on-image = "product-brand-on.png"
                                               data-off-image = "product-brand-off.png"
                                               data-on-title = "<?php echo e(translate('want_to_Turn_ON_Product_Brand').'?'); ?>"
                                               data-off-title = "<?php echo e(translate('want_to_Turn_OFF_Product_Brand').'?'); ?>"
                                               data-on-message = "<p><?php echo e(translate('if_enabled_customers_can_see_brands_on_the_app_and_website')); ?></p>"
                                               data-off-message = "<p><?php echo e(translate('if_disabled_brand_section_will_be_hidden_from_the_customer_app_and_website')); ?></p>">
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/business-settings/product-settings.blade.php ENDPATH**/ ?>