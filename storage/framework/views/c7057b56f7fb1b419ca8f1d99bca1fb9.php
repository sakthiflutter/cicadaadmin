        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body px-4 px-sm-5 pt-0 pb-sm-5">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="<?php echo e(route('admin.logout')); ?>" class="btn btn--primary min-w-120"><?php echo e(translate('ok')); ?></a>
...
<?php /**PATH /var/www/html/moores/resources/views/layouts/back-end/partials/_sign-out-modal.blade.php ENDPATH**/ ?>