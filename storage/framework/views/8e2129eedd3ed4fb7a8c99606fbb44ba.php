                            ...
                            <form class="mt-3 px-sm-2 pb-2" action="<?php echo e(route('user-update')); ?>" method="post"
                                ...
                                <div class="profile--info mb-4">
                                    <div class="position-relative profile-img mb-3">
                                        <img id="blah" alt=""
                                             src="<?php echo e(getValidImage(path: 'storage/app/public/profile/'.$customerDetail['image'], type: 'avatar')); ?>">
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/themes/default/web-views/users-profile/user-account.blade.php ENDPATH**/ ?>