        ...
        <div class="page-header">
            <div class="row align-items-end">
                <h2 class="col-sm mb-2 mb-sm-0 h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                    <img width="20" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/profile_setting.png')); ?>" alt="">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                                ...
                                <label for="phoneLabel" class="col-sm-3 col-form-label input-label"><?php echo e(translate('phone')); ?> <span
                                    ...
                                    <div class="col-sm-9 mb-3">
                                        <input class="form-control form-control-user phone-input-with-country-picker"
                                               type="tel" id="exampleInputPhone" value="<?php echo e($admin->phone ?? old('phone')); ?>"
                                               placeholder="<?php echo e(translate('enter_phone_number')); ?>" required>
                                        <div class="">
                                            <input type="text" class="country-picker-phone-number w-50" value="<?php echo e($admin->phone); ?>" name="phone" hidden  readonly>
                                        </div>
                                    </div>
                            </div>
                            <div class="row form-group">
                ...
                <div id="password-div" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <form id="change-password-form" action="<?php echo e(route('admin.profile.update',[$admin->id])); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?> <?php echo method_field('patch'); ?>
                            <div class="row form-group">
                                <label for="newPassword" class="col-sm-3 col-form-label input-label d-flex align-items-center">
                                    <?php echo e(translate('new_password')); ?>
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="js-toggle-password form-control password-check" id="newPassword"
                                               autocomplete="off" name="password" required minlength="8" placeholder="<?php echo e(translate('password_minimum_8_characters')); ?>"
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/profile/update-view.blade.php ENDPATH**/ ?>