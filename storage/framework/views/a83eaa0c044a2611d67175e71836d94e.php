        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><?php echo e(translate('about_us')); ?></h5>
                </div>
                <form action="<?php echo e(route('admin.business-settings.about-update')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="form-group">
                            <textarea name="about_us" id="editor" cols="30" rows="20" class="form-control summernote"><?php echo e($pageData['value']); ?></textarea>
                        </div>
                        <div class="form-group mb-2">
                            <input class="btn btn--primary btn-block" type="submit" name="btn" value="<?php echo e(translate('submit')); ?>">
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/business-settings/page/about-us.blade.php ENDPATH**/ ?>