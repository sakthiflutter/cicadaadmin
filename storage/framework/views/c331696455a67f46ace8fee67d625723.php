...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4 pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/system-setup.png')); ?>" alt="">
                                    ...
                                    <div class="swiper mySwiper pb-3">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/slider-1.png')); ?>"
                                                     loading="lazy"
                                                     alt="" class="dark-support rounded">
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                    <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/slider-2.png')); ?>"
                                                         loading="lazy"
                                                         alt="" class="dark-support rounded mb-4">
                                                    <p>
                                                        <?php echo e(translate('get_your_zip_file_from_the_purchased_addons_and_upload_it_and_activate_theme_with_your_Codecanyon_username_and_purchase_code').'.'); ?>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                    <img src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/slider-3.png')); ?>"
                                                         loading="lazy"
                                                         alt="" class="dark-support rounded mb-4">
                                                    <p>
                                                        <?php echo e(translate('now_you’ll_be_successfully_able_to_use_the_addons_for_your_6Valley_website')); ?>
        ...
        <div class="card mb-5">
            <div class="card-body pl-md-10">
                <h4 class="mb-3 text-capitalize d-flex align-items-center"><?php echo e(translate('upload_Addons')); ?></h4>
                        ...
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-9">
                            <div class="pl-sm-5">
                                ...
                                <ul class="pl-3 d-flex flex-column gap-2 instructions-list">
                                    <li>
                                        <?php echo e(translate('please_make_sure').','.translate('your_server_php').'"'.translate('upload_max_filesize').'"'.translate('value_is_grater_or_equal_to_20MB').'.'.translate('current_value_is').'-'.ini_get('upload_max_filesize').'B'); ?>

                                    </li>
                                    <li>
                                        <?php echo e(translate('please_make_sure').','.translate('your_server_php').'"'.translate('post_max_size').'"'.translate('value_is_grater_or_equal_to_20MB').'.'.translate('current_value_is') .'-'.ini_get('post_max_size').'B'); ?>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end">
                                <button type="<?php echo e(env('APP_MODE')!='demo'?'submit':'button'); ?>"
                                        class="btn btn--primary px-4 <?php echo e(env('APP_MODE')!='demo'?'':'call-demo'); ?>"
                                        id="upload-theme"><?php echo e(translate('upload')); ?></button>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="col-6 col-md-4 col-xxl-4">
                    <div class="card theme-card <?php echo e(theme_root_path() == $key ? 'theme-active':''); ?>">
                        <div class="card-header">
                            <h3 class="card-title">
                                <?php echo e(ucwords(str_replace('_', ' ', $data['name']))); ?>
                            ...
                            <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/delete.png')); ?>"
                                                             alt="">
                                                    </div>
                                                    <h3><?php echo e(translate('are_you_sure_you_want_to_delete_the')); ?> <?php echo e($data['name']); ?>?</h3>
                                                    <p class="mb-5"><?php echo e(translate('once_you_delete') .','. translate('you_will_lost_the_this') .' '.$data['name']); ?></p>
                                                    ...
                                                    <div class="d-flex justify-content-center gap-3 mb-3">
                                                        ...
                                                        <button type="submit" class="fs-16 btn btn-danger px-sm-5"
                                                                data-dismiss="modal"
                                                                data-path="<?php echo e($addon); ?>"
                                                                id="theme-delete"><?php echo e(translate('delete')); ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <button class="text-muted bg-transparent p-0 border-0" data-toggle="modal"
                                            ...
                                            src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/icons/check.svg')); ?>" class="svg <?php echo e($data['is_published'] == 1 ? 'text--primary' : ''); ?>"
                                            alt="">
                                    </button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body px-4 px-sm-5 text-center">
                                                    <div class="mb-3 text-center">
                                                        <img width="75"
                                                             src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/shift.png')); ?>"
                                                             alt="">
                                                    </div>
                                                    <h3><?php echo e(translate('are_you_sure').'?'); ?></h3>
                                                    <?php if($data['is_published']): ?>
                                                        <p class="mb-5"><?php echo e(translate('want_to_inactive_this') .' '. $data['name']); ?></p>
                                                    <?php else: ?>
                                                        <p class="mb-5"><?php echo e(translate('want_to_activate_this') .' '. $data['name']); ?></p>
                                                    <?php endif; ?>
                                                    <div class="d-flex justify-content-center gap-3 mb-3">
                                                        <button type="button" class="fs-16 btn btn-secondary px-sm-5"
                                                        ...
                                                        <button type="button" class="fs-16 btn btn--primary px-sm-5"
                                                                data-dismiss="modal"
                                                                data-path = "<?php echo e($addon); ?>"
                                                                id="publish-addon"><?php echo e(translate('yes')); ?>
                        ...
                        <div class="p-2 p-sm-3">
                            <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                                <img class="img-fit radius-10" alt=""
                                     src="<?php echo e(getValidImage(path: $addon.'/public/addon.png', type: 'backend-basic')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <span id="get-addon-upload-route" data-action="<?php echo e(route('admin.addon.upload')); ?>"></span>
    <span id="get-addon-publish-route" data-action="<?php echo e(route('admin.addon.publish')); ?>"></span>
    <span id="get-addon-delete-route" data-action="<?php echo e(route('admin.addon.delete')); ?>"></span>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/admin/addon.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/addons/index.blade.php ENDPATH**/ ?>