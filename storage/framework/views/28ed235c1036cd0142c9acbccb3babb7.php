            ...
            <div>
                <a href="<?php echo e(route('about-us')); ?>">
                    <div class="text-center">
                        <img class="size-60" src="<?php echo e(theme_asset(path: "public/assets/front-end/png/about-company.png")); ?>"
                             alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div>
                <a href="<?php echo e(route('contacts')); ?>">
                    <div class="text-center">
                        <img class="size-60" src="<?php echo e(theme_asset(path: "public/assets/front-end/png/contact-us.png")); ?>"
                             alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
        ...
        <div class="col-md-3 d-flex justify-content-center">
            <div>
                <a href="<?php echo e(route('helpTopic')); ?>">
                    <div class="text-center">
                        <img class="size-60" src="<?php echo e(theme_asset(path: "public/assets/front-end/png/faq.png")); ?>"
                             alt="">
                    </div>
                    <div class="text-center">
                        <p class="m-0">
        ...
        <div class="bg-white-overlay-50">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    <div class="mt-3">
                        <p class="text-align-direction __text-16px"><?php echo e($web_config['copyright_text']->value); ?></p>
                    </div>
                    <div
...
<?php /**PATH /var/www/html/moores/resources/themes/default/layouts/front-end/partials/_footer.blade.php ENDPATH**/ ?>