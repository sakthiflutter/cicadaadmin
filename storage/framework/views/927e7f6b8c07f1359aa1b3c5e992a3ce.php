<div class="navbar-tool dropdown me-2 <?php echo e(Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'); ?>">
        ...
        <a class="navbar-tool-text ms-2"
           href="<?php echo e(route('shop-cart')); ?>"><small><?php echo e(translate('my_cart')); ?></small>
            <span class="cart-total-price font-bold fs-14">
                <?php echo e(webCurrencyConverter(amount: \App\Utils\CartManager::cart_total_applied_discount(\App\Utils\CartManager::get_cart()))); ?>
    ...
    <div
        class="dropdown-menu dropdown-menu-<?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?> __w-20rem cart-dropdown py-0">
        <div class="widget widget-cart px-3 pt-2 pb-3">
            ...
            <?php if($cart->count() > 0): ?>
                ...
                <div class="dropdown-saved-amount text-center  align-items-center justify-content-center text-accent mb-3 <?php echo e($totalSavedAmount <= 0 ? 'd-none' : 'd-flex'); ?>">
                    ...
                    <small><?php echo e(translate('you_have_saved')); ?> <span
                            class="total_discount"><?php echo e(webCurrencyConverter(amount: $totalSavedAmount)); ?></span>!</small>
                </div>
                                ...
                                <a class="d-block me-2 position-relative overflow-hidden"
                                   href="<?php echo e(route('product',$cartItem['slug'])); ?>">
                                    <img width="64" class="<?php echo e($product ? ($product->status == 0?'blur-section':'') : 'blur-section'); ?>"
                                         src="<?php echo e(getValidImage(path: 'storage/app/public/product/thumbnail/'.$cartItem['thumbnail'], type: 'backend-product')); ?>"
                                ...
                                <div
                                    ...
                                    <div class="w-0 flex-grow-1">
                                        ...
                                        <?php if(!empty($cartItem['variant'])): ?>
                                            <div>
                                                <span
                                                    class="__text-12px"><?php echo e(translate('variant')); ?> : <?php echo e($cartItem['variant']); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <div class="widget-product-meta">
                                            ...
                                            <span
                                                class="text-accent me-2 discount_price_of_<?php echo e($cartItem['id']); ?>">
...
<?php /**PATH /var/www/html/moores/resources/themes/default/layouts/front-end/partials/_cart.blade.php ENDPATH**/ ?>