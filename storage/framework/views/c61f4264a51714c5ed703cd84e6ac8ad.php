<?php $__env->startSection('title'); ?>
    <?php echo e(Request::is('chat/seller') ? translate('chat_with_vendor') : translate('chat_with_delivery_man')); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="d-flex justify-content-between align-items-center gap-2 mb-3 d-lg-none">
                    <h5 class="font-bold m-0 fs-16"><?php echo e(translate('inbox')); ?></h5>
                    ...
                    <div class="col-lg-4 chatSel">
                        <div class="chat--sidebar-card h-100">
                            ...
                            <div class="inbox_chat">
                                ...
                                <?php if(isset($inhouseShop)): ?>
                                    <div class="chat_list <?php echo e(request()->has('id') && request('id') == 0 ? 'active':''); ?> get-view-by-onclick"
                                         data-link="<?php echo e(route('chat', ['type' => 'seller'])); ?>/?id=<?php echo e('0'); ?>" id="user_<?php echo e('0'); ?>">
                                            ...
                                            <div class="chat_ib">
                                                <div>
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-1">
                                                        <h5 class="<?php echo e($inhouseShopUnseenMessage == 0 ? 'active-text' : ''); ?>"><?php echo e($web_config['name']->value); ?></h5>
                                                        <span class="date">
                                                                <?php echo e($inhouseShop->created_at->diffForHumans()); ?>

                                                            </span>
                                                    </div>
                                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                                        <?php if($inhouseShop->message): ?>
                                                            <span class="last-msg"><?php echo e($inhouseShop->message); ?></span>
                                                        <?php elseif(json_decode($inhouseShop['attachment'], true) !=null): ?>
                                                            <span class="last-msg">
                                                                <i class="fa fa-paperclip pe-1"></i>
                                                                <?php echo e(translate('sent_attachments')); ?>

                                                            </span>
                                                        <?php endif; ?>
                                                        <?php if( $inhouseShopUnseenMessage >0): ?>
                                                            <span class="new-msg badge btn--primary rounded-full">
                                                                <?php echo e($inhouseShopUnseenMessage); ?>
                                ...
                                <?php if(isset($unique_shops)): ?>
                                    <?php $__currentLoopData = $unique_shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="chat_list <?php echo e(($last_chat->delivery_man_id==$unique_id || $last_chat->shop_id==$unique_id) ? 'active' : ''); ?> get-view-by-onclick"
                                            data-link="<?php echo e(route('chat', ['type' => $type])); ?>/?id=<?php echo e($unique_id); ?>" id="user_<?php echo e($unique_id); ?>">
                                            <div class="chat_people">
                                                <div class="chat_img">
                                                    <?php if($shop->delivery_man_id): ?>
                                                        <img alt="" class="__inline-14 __rounded-10 img-profile"
                                                             src="<?php echo e(getValidImage(path: 'storage/app/public/delivery-man/'.$shop->deliveryMan->image, type: 'avatar')); ?>">
                                                    <?php else: ?>
                                                        <img alt="" class="__inline-14 __rounded-10 img-profile"
                                                ...
                                                <div class="chat_ib">
                                                    <div>
                                                        ...
                                                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                                                            ...
                                                            <?php elseif(json_decode($shop['attachment'], true) !=null): ?>
                                                                <span class="last-msg">
                                                                    <i class="fa fa-paperclip pe-1"></i>
                                                                    <?php echo e(translate('sent_attachments')); ?>
                                    ...
                                    <div class="inbox_msg position-relative">
                                        <div class="mesgs">
                                            <a class="msg-user" href="#">
                                                ...
                                                <?php if($last_chat->delivery_man_id): ?>
                                                    <img alt="" class="img" src="<?php echo e(getValidImage(path: 'storage/app/public/delivery-man/'.$last_chat->deliveryMan->image, type: 'avatar')); ?>">
                                                <?php else: ?>
                                                    <?php if(isset($last_chat->admin_id) && $last_chat->admin_id == 0): ?>
                                                        <img alt="" class="img" src="<?php echo e(getValidImage(path: 'storage/app/public/company/'.($web_config['fav_icon']->value), type: 'shop')); ?>">
                                                    <?php else: ?>
                                                        <img alt="" class="img" src="<?php echo e(getValidImage(path: 'storage/app/public/shop/'.($last_chat->shop->image), type: 'shop')); ?>">
                                                    <?php endif; ?>
                                                <?php endif; ?>

                                                <?php if(isset($last_chat->admin_id) && $last_chat->admin_id == 0): ?>
                                                    <h5 class="m-0"><?php echo e($web_config['name']->value); ?></h5>
                                                <?php else: ?>
                                                    <h5 class="m-0"><?php echo e($last_chat->deliveryMan?$last_chat->deliveryMan->f_name.' '.$last_chat->deliveryMan->l_name : $last_chat->shop->name); ?></h5>
                                                <?php endif; ?>
                                            </a>
                                            ...
                                            <div class=" msg_history d-flex flex-column-reverse" id="show_msg">
                                                <?php if(isset($chattings)): ?>
                                                    <?php $__currentLoopData = $chattings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($chat->sent_by_seller || $chat->sent_by_admin || $chat->sent_by_delivery_man): ?>
                                                            <div class="incoming_msg d-flex">
                                                                <div class="incoming_msg_img">
                                                                    <?php if(isset($shop->delivery_man_id)): ?>
                                                                        <img alt="" src="<?php echo e(getValidImage(path: 'storage/app/public/delivery-man/'.$last_chat->deliveryMan->image, type: 'avatar')); ?>">
                                                                    <?php elseif(isset($last_chat->shop)): ?>
                                                                        <img alt="" src="<?php echo e(getValidImage(path: 'storage/app/public/shop/'.$last_chat->shop->image, type: 'shop')); ?>">
                                                                    <?php elseif(isset($chat->sent_by_admin)): ?>
                                                                        <img alt="" src="<?php echo e(getValidImage(path: 'storage/app/public/company/'.($web_config['fav_icon']->value), type: 'shop')); ?>">
                                                                    <?php endif; ?>
                                                                </div>
                                                                            ...
                                                                            <div class="row g-2 flex-wrap mt-3">
                                                                                <?php $__currentLoopData = json_decode($chat['attachment']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <div class="col-sm-6 col-md-4 position-relative img_row<?php echo e($index); ?>">
                                                                                        <a data-lightbox="mygallery" href="<?php echo e(dynamicStorage(path: "storage/app/public/chatting/".$photo)); ?>"
                                                                                           class="aspect-1 overflow-hidden d-block border rounded">
                                                                                            <img class="img-fit" alt="<?php echo e(translate('chatting')); ?>"
                                                                                                 src="<?php echo e(getValidImage(path: 'storage/app/public/chatting/'.$photo, type: 'product')); ?>">
                                                                                        </a>
                                                                                    </div>
                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                            </div>
                                        ...
                                        <?php if($last_chat->shop && $last_chat->shop->temporary_close || (isset($last_chat->admin_id) && $last_chat->admin_id == 0 && getWebConfig(name: 'temporary_close')['status'])): ?>
                                            <div class="temporarily-closed-sticky-alert">
                                                <div class="alert-box">
                                                    <div><img src="<?php echo e(theme_asset('public/assets/front-end/img/icons/warning.svg')); ?>" alt=""></div>
                                                    <div>
                                                        <?php echo e(translate('sorry')); ?> !
                                                        <?php echo e(translate('currently_we_are_not_available.')); ?>

                                                        <?php echo e(translate('but_you_can_ask_or_still_message_us.')); ?>

                                                        <?php echo e(translate('We_will_get_back_to_you_soon.')); ?>

                                                        <?php echo e(translate('Thank_you_for_your_patience.')); ?>.
                                                    </div>
                        ...
                        <?php else: ?>
                            <div class="card Chat __shadow h-100 d-flex flex-column justify-content-center rounded-left-0">
                                <div class="text-center">
                                    <img src="<?php echo e(theme_asset(path: 'public/assets/front-end/img/empt-msg.png')); ?>" alt="">
                        ...
                        if (data.length != 0) {
                            data.map((element, index) => {
                                ...
                                if (element.sent_by_customer) {
                                    ...
                                    let img_path = element.image == 'def.png' ? `<?php echo e(dynamicStorage(path: 'storage/app/public/shop')); ?>/${element.image}` : `<?php echo e((isset($shop->delivery_man_id) && $shop->delivery_man_id) ? dynamicStorage(path: 'storage/app/public/delivery-man') : dynamicStorage(path: 'storage/app/public/shop')); ?>/${element.image}`;
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/themes/default/web-views/users-profile/user-inbox.blade.php ENDPATH**/ ?>