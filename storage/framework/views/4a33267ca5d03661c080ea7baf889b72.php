                    ...
                    <nav>
                        <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                            <a class="nav-link d-flex align-items-center gap-2 active" id="nav-home-tab"
                               ...
                               aria-selected="true">
                                <img width="22" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/mail-config.png')); ?>" alt="">
                            ...
                            <a class="nav-link d-flex align-items-center gap-2" id="nav-profile-tab" data-toggle="tab"
                               href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">
                                <img width="22" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/send-test-mail.png')); ?>"
                                     alt="">
                                ...
                                <?php if(isset($data_smtp)): ?>
                                    <div class="card-header">
                                        <h5 class="mb-0 d-flex align-items-center gap-2 text-capitalize">
                                            <img width="20" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/smtp.png')); ?>"
                                                 alt="">
                                        ...
                                        <label class="switcher">
                                            <input type="checkbox" name="status" value="1"
                                                   id="mail_config" <?php echo e($data_smtp['status']==1?'checked':''); ?> class="switcher_input toggle-switch-message"
                                                   data-modal-id = "toggle-modal"
                                                   data-toggle-id = "mail_config"
                                                   data-on-image = "maintenance_mode-on.png"
                                                   data-off-image = "maintenance_mode-off.png"
                                                   data-on-title = "<?php echo e(translate('want_to_Turn_ON_the_smtp_mail_config_option').'?'); ?>"
                                                   data-off-title = "<?php echo e(translate('want_to_Turn_OFF_the_smtp_mail_config_option').'?'); ?>"
                                                   data-on-message = "<p><?php echo e(translate('enabling_mail_configuration_services_will_allow_the_system_to_send_emails').'.'.translate('please_ensure_that_you_have_correctly_configured_the_SMTP_settings_to_avoid_potential_issues_with_email_delivery')); ?></p>"
                                                   data-off-message = "<p><?php echo e(translate('disabling_SMTP_mail_configuration_services_stops_email_sending')); ?></p>">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        <label
                                                            class="title-color mb-0"><?php echo e(translate('mailer_name')); ?></label>
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_mailer_name')); ?>"></i>
                                                    </div>
                                                    <input type="text"
                                                           placeholder="<?php echo e(translate('ex')); ?>:<?php echo e(translate('alex')); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        ...
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_the_name_of_the_host_of_your_mailing_service')); ?>"></i>
                                                    </div>
                                                    <input type="text" class="form-control" name="host"
                                                           placeholder="<?php echo e(translate('ex').':'); ?><?php echo e(translate('smtp.mailtrap.io')); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        ...
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_the_driver_for_your_mailing_service')); ?>"></i>
                                                    </div>
                                                    <input type="text" class="form-control" name="driver"
                                                           placeholder="<?php echo e(translate('ex')); ?>:<?php echo e(translate('smtp')); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        ...
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_the_port_number_for_your_mailing_service')); ?>"></i>
                                                    </div>
                                                    <input type="text" class="form-control" name="port"
                                                           placeholder="<?php echo e(translate('ex')); ?>:587"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        <label
                                                            class="title-color mb-0"><?php echo e(translate('username')); ?></label>
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_the_username_of_your_account')); ?>"></i>
                                                    </div>
                                                    <input type="text" placeholder="<?php echo e(translate('ex : yahoo')); ?>"
                                                           class="form-control"
                                                           name="username"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        <label
                                                            class="title-color mb-0"><?php echo e(translate('email_ID')); ?></label>
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_your_email_ID')); ?>"></i>
                                                    </div>
                                                    <input type="text"
                                                           placeholder="<?php echo e(translate('ex')); ?>:<?php echo e(translate('example@example.com')); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center gap-2 mb-2">
                                                        <label
                                                            class="title-color mb-0"><?php echo e(translate('encryption')); ?></label>
                                                        <i class="tio-info-outined" data-toggle="tooltip"
                                                           title="<?php echo e(translate('enter_the_encryption_type')); ?>"></i>
                                                    </div>
                                                    <input type="text"
                                                           placeholder="<?php echo e(translate('ex :')); ?>:<?php echo e(translate('tls')); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="js-form-message form-group">
                                                    ...
                                                    <span class="d-flex align-items-center gap-2">
                                                      ...
                                                      <i class="tio-info-outined" data-toggle="tooltip"
                                                         title="<?php echo e(translate('enter_your_password')); ?>"></i>
                                                    </span>
                                                    </label>
                                                    <div class="input-group input-group-merge">
                                                        <input type="password" class="js-toggle-password form-control"
                                                               ...
                                                               placeholder="<?php echo e(translate('ex')); ?>:123456"
                                        ...
                                        <div class="d-flex flex-wrap justify-content-end gap-10">
                                            <button type="reset"
                                                    class="btn btn-secondary px-5"><?php echo e(translate('reset')); ?></button>
                                            <button type="<?php echo e(env('APP_MODE')!='demo'?'submit':'button'); ?>"
                                                    class="btn btn--primary px-5 <?php echo e(env('APP_MODE')!='demo'?'':'call-demo'); ?>"><?php echo e(translate('save')); ?></button>
                                            <?php else: ?>
                                                <button type="submit"
                                                        class="btn btn--primary px-5"><?php echo e(translate('configure')); ?></button>
                                            <?php endif; ?>
                                        </div>
                        ...
                        <div class="card mt-3">
                            <form action="<?php echo e(route('admin.business-settings.mail.update-sendgrid')); ?>" method="post">
                                ...
                                <?php if(isset($data_sendgrid)): ?>
                                    <div class="card-header">
                                        <h5 class="mb-0 d-flex align-items-center gap-2 text-capitalize">
                                            <img width="20" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/smtp.png')); ?>" alt="">
                                        ...
                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input toggle-switch-message" name="status"
                                                   ...
                                                   data-on-image = "maintenance_mode-on.png"
                                                   data-off-image = "maintenance_mode-off.png"
                                                   data-on-title = "<?php echo e(translate('want_to_Turn_ON_the_sendgrid_mail_config_option').'?'); ?>"
                                                   data-off-title = "<?php echo e(translate('want_to_Turn_OFF_the_sendgrid_mail_config_option').'?'); ?>"
                                                   data-on-message = "<p><?php echo e(translate('enabling_mail_configuration_services_will_allow_the_system_to_send_emails').'.'.translate('please_ensure_that_you_have_correctly_configured_the_sendgrid_settings_to_avoid_potential_issues_with_email_delivery')); ?></p>"
                                                   data-off-message = "<p><?php echo e(translate('disabling_sendgrid_mail_configuration_services_stops_email_sending')); ?></p>">
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>
                                    <div class="card-body">
                    ...
                    <div class="swiper mySwiper pb-3">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3"
                                         src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/smtp-server.png')); ?>" loading="lazy"
                                         alt="">
                                    ...
                                    <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                        <li>
                                            <?php echo e(translate('contact_your_email_service_provider_or_IT_administrator_to_obtain_the_SMTP_server_details_such_as_hostname_port_username_and_password').'.'); ?>

                                        </li>
                                        <li><?php echo e(translate('note').':'); ?>

                                             <?php echo e(translate('if_you`re_not_sure_where_to_find_these_details,_check_the_email_provider`s_documentation_or_support_resources_for_guidance').'.'); ?>
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3"
                                         src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/config-smtp.png')); ?>" loading="lazy"
                                         alt="">
                                    ...
                                    <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                        ...
                                        <li><?php echo e(translate('choose_the_appropriate_encryption_method').' '.'(e.g., SSL,TLS)'.' '.translate('if_required').'.'); ?></li>
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3"
                                         src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/test-smtp.png')); ?>" loading="lazy"
                                         alt="">
                                    <h4 class="lh-md mb-3 text-capitalize"><?php echo e(translate('test_SMTP_connection')); ?></h4>
                                    <ul class="d-flex flex-column px-4 gap-2 mb-4">
                                        <li><?php echo e(translate('click_on_the').'"'.translate('send_test_mail').'"'.translate('button_to_verify_the_SMTP_connection')); ?>
                                        ...
                                        <li><?php echo e(translate('note').':'.translate('if_you`re_unsure_about_the_SMTP_settings,_contact_your_email_service_provider_or_IT_administrator_for_assistance').'.'); ?>
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3"
                                         src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/enable-mail-config.png')); ?>"
                                         loading="lazy" alt="">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 text-center">
                    <div class="d-flex flex-column align-items-center gap-2">
                        <img width="80" class="mb-3" src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/img/send-mail.png')); ?>"
                             loading="lazy" alt="">
                        <h4 class="lh-md"><?php echo e(translate('send_a_test_mail_to_your_email').'?'); ?>  </h4>
                        <p class="text-muted"><?php echo e(translate('a_test_mail_will_be_send_to_your_email_to')); ?>

                            <br> <?php echo e(translate('confirm_it_works_perfectly').'.'); ?></p>
                        <button type="button" id="text-mail-send"
                                class="btn btn--primary px-5 px-sm-10 text-capitalize"><?php echo e(translate('send_mail')); ?></button>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <span id="get-send-mail-route-text" data-action="<?php echo e(route('admin.business-settings.mail.send')); ?>"
          data-error-text="<?php echo e(translate("email_configuration_error").'!!'); ?>"
          data-success-text="<?php echo e(translate("email_configured_perfectly")); ?>"
          data-info-text="<?php echo e(translate("email_status_is_not_active").'!'); ?>"
          data-invalid-text="<?php echo e(translate("invalid_email_address").'!'); ?>">
    </span>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(dynamicAsset(path: 'public/assets/back-end/js/admin/business-setting/mail.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/moores/resources/views/admin-views/business-settings/mail/index.blade.php ENDPATH**/ ?>